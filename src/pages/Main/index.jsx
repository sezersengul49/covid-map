...
import { ZoomableGroup,Annotation } from "react-simple-maps"
...
const Main = () => {
  ...
  return (
    <div className=" h-[calc(100vh-74px)] bg-zinc-800 flex flex-col flex-1 text-white overflow-hidden justify-center items-center wrapper md:pt-20">
